...
namespace BikeShop.BicycleChallenge
{
    ...
    /// <summary>
    /// The collection class to implement the refined Components reference for the Bicycle class
    /// </summary>
    public class BicycleComponentsCollection : ICollectionExpression<BikeShop.BicycleChallenge.IComponent>, ICollection<BikeShop.BicycleChallenge.IComponent>
    {
        
        private IBicycle _parent;
        ...
        {
            return Enumerable.Empty<BikeShop.BicycleChallenge.IComponent>().Concat(this._parent.Frame).Concat(this._parent.Fork).Concat(this._parent.Wheels).Concat(this._parent.HandleBar).GetEnumerator();
        }
