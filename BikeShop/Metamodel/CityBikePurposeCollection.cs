...
namespace BikeShop.BicycleChallenge
{
    ...
    /// <summary>
    /// The collection class to implement the refined Purpose attribute for the CityBike class
    /// </summary>
    public class CityBikePurposeCollection : ICollectionExpression<Purpose>, IListExpression<Purpose>
    {
        
        private ICityBike _parent;
        ...
        /// </summary>
        public CityBikePurposeCollection(ICityBike parent)
        {
            this._parent = parent;
        }
        ...
        public virtual Purpose this[int index]
        {
            get
            {
                if ((index < 1))
                {
                    return CityBikePurposeCollection._standardValues[index];
                }
                int runningIndex = 1;
        ...
        {
            if (CityBikePurposeCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            CityBikePurposeCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return CityBikePurposeCollection._standardValues.Cast<Purpose>().GetEnumerator();
        }
        ...
        public virtual int IndexOf(Purpose item)
        {
            ...
            {
                if ((CityBikePurposeCollection._standardValues[i] == item))
                {
                    return i;
                }
            }
