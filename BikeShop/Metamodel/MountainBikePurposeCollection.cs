...
namespace BikeShop.BicycleChallenge
{
    ...
    /// <summary>
    /// The collection class to implement the refined Purpose attribute for the MountainBike class
    /// </summary>
    public class MountainBikePurposeCollection : ICollectionExpression<Purpose>, IListExpression<Purpose>
    {
        ...
        public virtual Purpose this[int index]
        {
            get
            {
                if ((index < 2))
                {
                    return MountainBikePurposeCollection._standardValues[index];
                }
                int runningIndex = 2;
        ...
        {
            if (MountainBikePurposeCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            MountainBikePurposeCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return MountainBikePurposeCollection._standardValues.Cast<Purpose>().GetEnumerator();
        }
        ...
        public virtual int IndexOf(Purpose item)
        {
            ...
            {
                if ((MountainBikePurposeCollection._standardValues[i] == item))
                {
                    return i;
                }
            }
