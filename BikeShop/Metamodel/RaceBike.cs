...
namespace BikeShop.BicycleChallenge
{
    ...
    /// <summary>
    /// The default implementation of the RaceBike class
    /// </summary>
    [XmlNamespaceAttribute("http://www.fzi.de/MULTI/2017/bicycleChallenge")]
    [XmlNamespacePrefixAttribute("bikes")]
    [ModelRepresentationClassAttribute("http://www.fzi.de/MULTI/2017/bicycleChallenge#//RaceBike")]
    public partial class RaceBike : ModelElement, IRaceBike, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Certified property
        /// </summary>
        private bool _certified;
        
        private static Lazy<ITypedElement> _certifiedAttribute = new Lazy<ITypedElement>(RetrieveCertifiedAttribute);
        ...
        public bool Certified
        {
            ...
            set
            {
                ...
                {
                    bool old = this._certified;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnCertifiedChanging(e);
                    this.OnPropertyChanging("Certified", e, _certifiedAttribute);
                    this._certified = value;
                    this.OnCertifiedChanged(e);
                    this.OnPropertyChanged("Certified", e, _certifiedAttribute);
                }
            }
        }
        ...
        ICollectionExpression<Purpose> IBicycle.Purpose
        {
            get
            {
                return new RaceBikePurposeCollection(this);
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new RaceBikeChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new RaceBikeReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://www.fzi.de/MULTI/2017/bicycleChallenge#//RaceBike")));
                }
        ...
        /// <summary>
        /// Gets fired before the Certified property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> CertifiedChanging;
        
        /// <summary>
        /// Gets fired when the Certified property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> CertifiedChanged;
        ...
        private static ITypedElement RetrieveCertifiedAttribute()
        {
            return ((ITypedElement)(((ModelElement)(BikeShop.BicycleChallenge.RaceBike.ClassInstance)).Resolve("Certified")));
        }
        
        /// <summary>
        /// Raises the CertifiedChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnCertifiedChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.CertifiedChanging;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the CertifiedChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnCertifiedChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.CertifiedChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// The collection class to to represent the children of the RaceBike class
        /// </summary>
        public class RaceBikeChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private RaceBike _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public RaceBikeChildrenCollection(RaceBike parent)
            {
                this._parent = parent;
            }
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.RaceFrame != null))
                    {
                        count = (count + 1);
                    }
            ...
            {
                this._parent.RaceFrameChanged += this.PropagateValueChanges;
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.RaceFrame == null))
                {
                    IRaceFrame raceFrameCasted = item.As<IRaceFrame>();
                    if ((raceFrameCasted != null))
                    {
                        this._parent.RaceFrame = raceFrameCasted;
                        return;
                    }
                }
                if ((this._parent.Fork == null))
            ...
            {
                if ((item == this._parent.RaceFrame))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.RaceFrame != null))
                {
                    array[arrayIndex] = this._parent.RaceFrame;
            ...
            {
                if ((this._parent.RaceFrame == item))
                {
                    this._parent.RaceFrame = null;
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.RaceFrame).Concat(this._parent.Fork).Concat(this._parent.Wheels).Concat(this._parent.HandleBar).GetEnumerator();
            }
        }
        ...
        /// The collection class to to represent the children of the RaceBike class
        /// </summary>
        public class RaceBikeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public RaceBikeReferencedElementsCollection(RaceBike parent)
            {
                this._parent = parent;
            }
