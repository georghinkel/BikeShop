...
namespace BikeShop.BicycleChallenge
{
    ...
    /// <summary>
    /// The collection class to implement the refined Purpose attribute for the RaceBike class
    /// </summary>
    public class RaceBikePurposeCollection : ICollectionExpression<Purpose>, IListExpression<Purpose>
    {
        
        private IRaceBike _parent;
        ...
        /// </summary>
        public RaceBikePurposeCollection(IRaceBike parent)
        {
            this._parent = parent;
        }
        ...
        public virtual Purpose this[int index]
        {
            get
            {
                if ((index < 2))
                {
                    return RaceBikePurposeCollection._standardValues[index];
                }
                int runningIndex = 2;
        ...
        {
            if (RaceBikePurposeCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            RaceBikePurposeCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return RaceBikePurposeCollection._standardValues.Cast<Purpose>().GetEnumerator();
        }
        ...
        public virtual int IndexOf(Purpose item)
        {
            ...
            {
                if ((RaceBikePurposeCollection._standardValues[i] == item))
                {
                    return i;
                }
            }
